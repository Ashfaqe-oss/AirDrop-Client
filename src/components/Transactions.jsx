...
const TransactionsCard = ({
  ...
  return (
    <div
      className="bg-[#181918] m-4 flex flex-wrap
      2xl:min-w-[450px]
      2xl:max-w-[500px]
      sm:min-w-[270px]
      sm:max-w-[300px]
    ...
    >
      <div className="flex flex-col items-center w-full mt-3">
        <div className="dislay-flex justify-start w-full mb-6 p-2">
          <a
  ...
  return (
    <div className="flex w-full justify-center items-center 2xl:px-20 gradient-bg-transactions">
      <div className="flex flex-col md:p-12 py-12 px-4">
        {currentAccount ? (
          <h3 className="text-white font-poppins text-3xl text-center my-2">
            Latest Transactions
          </h3>
        ) : (
