      ...
      <div className="flex mf:flex-row flex-col items-start justify-between py-12 md:p-20 px-4">
        <div className="flex flex-1 justify-start flex-col mf:mr-10">
          ...
          <p className="text-left mt-5 text-white font-light md:w-9/12 w-11/12 text-base">
            Exploring the new crpto world with Airdrop
          </p>
          {!currentAccount ? (
            <button
              type="button"
              className="flex flex-grow justify-center items-center my-9 bg-[#2952e3] p-3 rounded-full cursor-pointer hover:bg-[#2546bd]"
            ...
            <button
              type="button"
              disabled
              className="flex flex-grow justify-center items-center my-9 bg-[#4a5783] p-3 rounded-full  hover:bg-[#4a5783]"
              // onClick={connectWallet}
            >
              <p className="text-white text-base font-semibold">
                You are Connected !
          ...
          <div className="grid font-poppins text-slate-200 sm:grid-cols-3 grid-cols-2 w-full mt-10">
            ...
            <div className={`md:rounded-bl-2xl ${commonStyles}`}>Web 3.1</div>
            <div className={`rounded-bl-2xl ${commonStyles}`}>
              Free to Transact
            </div>
            <div className={`rounded-br-2xl ${commonStyles}`}>Earn stake</div>
          </div>
        </div>
        ...
        <div className="flex flex-col flex-1 items-center justify-start w-full mf:mt-0 mt-10">
          <div className="p-3 justify-end items-start flex-col rounded-xl h-40 sm:w-72 w-full my-5 eth-card white-glassmorphism">
            <div className="flex justify-between flex-col w-full h-full">
              <div className="flex justify-between items-start">
                <div className="w-10 h-10 -top-10 rounded-full border-2 border-white flex justify-center items-center">
          ...
          <div className="p-5 sm:w-96 w-full flex flex-col justify-start items-center blue-glassmorphism">
            ...
            {isLoading ? (
              ...
              <button
                type="button"
                className="text-gray-300 w-full mt-2 border-[1px] p-2 border-[#3d4f7c] rounded-full cursor-pointer"
