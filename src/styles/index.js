const styles = {
  // App.js
  container: "flex justify-center min-h-screen sm:px-16 px-6 bg-neutra-900",
  innerContainer:
  ...
  subTitle: "text-slate-200 tracking-wider font-poppins font-medium mt-3 text-base",
  ...
  // WalletButton
  walletButton:
    " border-none outline-none px-6 py-2 font-poppins font-bold text-lg text-white rounded-3xl leading-[24px] hover:bg-pink-600 transition-all",

  // loader
  loader: "flex justify-center items-center flex-col w-full min-h-full",
  loaderImg: "w-56 h-56 object-contain",
  loaderText:
    "font-poppins font-normal text-slate-200 text-lg text-center mt-10",
